...
public class JLibrosa {
    ...
    private int sampleRate = 16000; //-1
    private int noOfChannels = -1;
    private double fMax = 44100 / 2.0; //44100 / 2.0;
    ...
    public float[][] generateMelSpectroGram(float[] yValues, int mSampleRate) {
        float[][] melSVal = this.generateMelSpectroGram(yValues, mSampleRate, this.n_fft, this.n_mels, this.hop_length);
        return melSVal;
    }
    ...
    public Complex [][] generateSTFTFeatures1(float[] magValues, int mSampleRate, int nMFCC) {
